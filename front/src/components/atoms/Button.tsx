...
const buttonClass: string =
  'font-bold rounded-full py-4 px-16 shadow-lg shadow-shadow transition duration-200 ease-in-out hover:shadow-md flex items-center justify-center relative transform active:scale-95 active:shadow-inner'
...
const spanClass: string =
  'absolute top-0 left-0 rounded-full opacity-50 shadow-md shadow-shadow w-full h-full duration-200 active:shadow-inner'
